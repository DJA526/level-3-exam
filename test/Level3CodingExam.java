...
public class Level3CodingExam {
	 ...
	 * PART A
	 * 
	 * There are 2 candidates for "Person of the Year 2014". The votes are contained in an ArrayList. Not every voter
	 * has capitalized the name of their choice in the same way. This question is part of Stanford University's CS106
	 * mid-term exam.
	 **/
	@Test
	 ...
	 * PART B
	 * 
	 * To complete this exercise, you need to count the number of matching entries in 2 HashMaps. More information about
	 * the problem is here: http://bit.ly/stanford-exam-part7 This question is part of Stanford University's CS106 final
	 * exam.
	 **/
	@Test
